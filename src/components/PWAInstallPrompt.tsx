...
export const PWAInstallPrompt: React.FC = () => {
  ...
  return (
    <>
      {/* Bottom-right floating install card (non-intrusive, never overlaps main content) */}
      <div className="fixed bottom-4 right-4 z-40 max-w-xs w-[calc(100%-2rem)] sm:w-80">
        <div className="bg-slate-900 text-slate-200 border border-slate-700 rounded-xl shadow-xl p-3 flex items-start gap-3">
          <div className="w-8 h-8 rounded-lg bg-blue-600/20 flex items-center justify-center shrink-0">
            <Smartphone className="w-4 h-4 text-blue-400" />
          </div>
          <div className="min-w-0 flex-1">
            <p className="text-xs font-medium text-slate-100 leading-snug">
              Installez YM-TRANSIT sur votre téléphone
            </p>
            <div className="flex items-center gap-2 mt-2">
              ...
              <button
                ...
                className="text-slate-400 hover:text-white text-[11px] px-1.5 py-1 cursor-pointer"
              >
                Plus tard
              </button>
            </div>
